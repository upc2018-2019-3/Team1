...
<div class="panel-group col-sm-2" id="hrms_sidebar_left" role="tablist" aria-multiselectable="true">
    <ul class="nav nav-pills nav-stacked emp_sidebar">
        <li role="presentation" class="active">
            ...
            <ul class="nav nav-pills nav-stacked" id="collapse_emp">
                ...
                <li role="presentation"><a href="#" class="quit_info">离职信息</a></li>
            </ul>
        </li>
    </ul>
    ...
    <ul class="nav nav-pills nav-stacked dept_sidebar">
        <li role="presentation" class="active">
            <a href="#"  data-toggle="collapse" data-target="#collapse_data">
                <span class="glyphicon glyphicon-cloud" aria-hidden="true">数据统计</span>
            </a>
            <ul class="nav nav-pills nav-stacked" id="collapse_data">
                <li role="presentation"><a href="#" class="data_info">数据统计</a></li>
            </ul>
        </li>
    </ul>
