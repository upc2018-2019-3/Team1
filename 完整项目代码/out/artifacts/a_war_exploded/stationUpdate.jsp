...
<body>
<form action="stationUpdateServlet" method="post" class="form-horizontal update_emp_form"> 
<div class="modal fade sta-update-modal" tabindex="-1" role="dialog" aria-labelledby="sta-update-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">岗位信息变动</h4>
            </div>
            <div class="modal-body">
                <!-- <form class="form-horizontal update_sta_form"> -->
            ...
            <div class="modal-footer">
                ...
                <!-- <button type="button" class="btn btn-primary sta_save_btn">保存</button> -->
                <input type="submit" class="btn btn-primary sta_save_btn" value="保存">
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
