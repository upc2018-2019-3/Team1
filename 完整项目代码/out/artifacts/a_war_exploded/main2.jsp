...
<div class="hrms_container">
        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎进入A公司的人力资源管理系统！</h3>
                </div>
                    ...
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" style="text-align: center;">
                                <img class="img-responsive center-block" src="images/1.jpg" alt="company1">
                                <div class="carousel-caption">
                                    <h3>丰富的信息资源</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="images/2.jpg" alt="company2">
                                <div class="carousel-caption">
                                    <h3>团队合作，共同进步</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="images/3.jpg" alt="company3">
                                <div class="carousel-caption">
                                    <h3>舒适的办公环境</h3>
                                </div>
                            </div>
    ...
    <form action="ZhuceService" method="post">
    </form>
</div><!-- /.hrms_container -->
